                        ...
                        <div class="card-body">
                            <div class="mb-1 row">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Isi Surat</th>
                                        <td>{{  $detail->isisurat }}</td>
                                    </tr>
                                    <tr>
                                        <th>Tanggal Surat</th>
                                        <td>{{  $detail->tglsurat }}</td>
                                    </tr>
                                    <tr>
                                        <th>Perihal</th>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <embed src="{{ url("storage/users/". $detail->foto) }}" width="400" height="715"
