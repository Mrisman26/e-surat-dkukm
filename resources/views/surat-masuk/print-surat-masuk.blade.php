                ...
                <div class="col">
                    ...
                    <table class="table table-bordered border-dark">
                        <thead>
                            ...
                            <th style="align-middle">Tanggal Di Terima</th>
                            <th style="align-middle">Perihal</th>
                            <th style="align-middle">Pengirim</th>
                            <th style="align-middle">Tujuan Bidang</th>
                            <th style="align-middle">Status Disposisi</th>
                        </thead>
                        <tbody>
                            @if ($cetak)
                            @foreach ($cetak as $item)
                                <tr>
                                    ...
                                    <td style="align-middle">{{ $item->tglditerima }}</td>
                                    <td style="align-middle">{{ $item->perihal }}</td>
                                    <td style="align-middle">{{ $item->pengirim }}</td>
                                    <td style="align-middle">{{ $item->namabidang }}</td>
                                    <!-- Tambahkan field-table yang lain sesuai dengan kebutuhan -->
                                    <td style="align-middle">{{ $item->status }}</td>
                                    {{--  <td>
